          ...
          callback: async (html) => {
            ...
            if (defenseItem) {
              ...
              if (defenseMethod === "threshold") {
                ...
                await this._rollDefenseAgainstNPCDiceAttack(defenseItem, itemType, attackName, attackResult, defenderActor, weaponDamageValue, damageValueBonus, defenderToken);
              }
            }
          }
        },
